...
SECRET_KEY = 'django-insecure-am*2gemq^sl1u0)_&x++gddabj&=tkjr#s0!)%79u8)x2wz^8u'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'pizza_time', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
